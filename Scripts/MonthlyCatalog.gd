...
static func ativos() -> Array[Dictionary]:
	...
	_item(&"p03_renascimento", "RENASCIMENTO", "Planta uma semente de retorno. Se o casco cair, você renasce nela uma vez.", 22000, Color("52ff91"), "JUL • VERDE", [4, 5, 2], &"", "Verde representa recomeço, cuidado e crescimento.", "res://Habilidades/monthly_p03.tres"),
	...
	_item(&"p08_presente_misterioso", "PRESENTE MISTERIOSO", "Planta uma caixa que atrai inimigos e explode, derrotando quem se aproximar.", 20000, Color("ff4c61"), "DEZ • NATAL", [3, 3, 3], &"", "Um presente legível antes de abrir, sem depender apenas da sorte.", "res://Habilidades/monthly_p08.tres"),
	_item(&"p10_laco_uniao", "LAÇO DA UNIÃO", "Conecta os inimigos da área a um laço central; destrua o laço para romper todos de uma vez.", 18000, Color("ff5b8d"), "JUN • VERMELHO", [4, 5, 2], &"", "Conexão, cuidado e responsabilidade compartilhada.", "res://Habilidades/monthly_p10.tres"),
	...
	_item(&"p14_tempestade_verde", "TEMPESTADE VERDE", "Invoca uma chuva diagonal de folhas a 315°, com dano baixo e perfuração evolutiva.", 18000, Color("48f49a"), "JUN • AMBIENTE", [4, 5, 2], &"", "Uma frente verde transforma o ambiente em chuva ofensiva.", "res://Habilidades/monthly_p14.tres"),
...
static func armas() -> Array[Dictionary]:
	...
	_item(&"a06_feixe_perielio", "FEIXE DO PERIÉLIO", "Laser contínuo de alcance infinito: cresce de 0,2 até 5 DPS e sobrecarrega após 10 segundos.", 100000, Color("ffd83d"), "JAN • PERIÉLIO", [5, 5, 5], &"sem_upgrades", "A proximidade máxima da Terra ao Sol inspira um feixe que intensifica enquanto permanece ativo."),
	...
	_item(&"a13_canhao_lua_fria", "CANHÃO DO SOLSTÍCIO", "Dispara gelo azul-claro de baixo dano. Cada impacto reduz 10% da velocidade; na quinta camada o alvo congela e se rompe após 3 segundos.", 16500, Color("90dcff"), "DEZ • SOLSTÍCIO", [2, 5, 3], &"", "As noites longas do solstício de dezembro viram acúmulo de frio e controle progressivo."),
	]
...
static func personalizacao() -> Array[Dictionary]:
	return [
		...
		},
		{
			...
			"preco": 1600, "cor": Color("ffffffff"), "raridade": "MODELO • DELTA",
		...
		},
		{
			...
			"preco": 2200, "cor": Color("ffffffff"), "raridade": "MODELO • ORBITAL",
		...
		},
		{
			...
			"preco": 1900, "cor": Color("ffffffff"), "raridade": "MODELO • DARDO",
		...
		},
		{
			...
			"preco": 2500, "cor": Color("ffffffff"), "raridade": "MODELO • INTERCEPTOR",
		...
		},
		{
			...
			"preco": 2800, "cor": Color("ffffffff"), "raridade": "MODELO • ESTELAR",
		...
		{
			"id": &"c07_modelo_o", "nome": "MODELO K",
			"descricao": "Uma estrela pilotável. A nave inteira acompanha a paleta escolhida.",
			"preco": 22000, "cor": Color("fff15a"), "raridade": "MODELO • K",
		...
		{
			"id": &"c08_modelo_spectrum", "nome": "MODELO SPECTRUM",
			"descricao": "Chassi cromático que percorre lentamente todo o espectro RGB.",
			"preco": 10000, "cor": Color("57eaff"), "raridade": "MODELO • SPECTRUM",
			"stats": [3, 3, 3], "conquista": &"combo_213_spectrum",
			"requer_conquista": &"combo_213_spectrum",
			"contexto": "Uma homenagem ao primeiro jogador à atingir o combo de 213x. Inclui rastro arco-íris exclusivo.",
		...
		},
		{
			...
			"preco": 10000, "cor": Color("ff2b2b"), "raridade": "MODELO • FSPEED",
			"stats": [3, 3, 3], "conquista": &"pontos_75000000_fspeed",
			"requer_conquista": &"pontos_75000000_fspeed",
			"contexto": "Uma homenagem ao primeiro jogadora zerar o jogo com a marca de 75 milhões de pontos. Inclui rastro de pneus exclusivo.",
		...
		{
			"id": &"c22_rastro_spectrum", "nome": "ARCO-ÍRIS SPECTRUM",
			"descricao": "Sete faixas suaves formam um rastro arco-íris contínuo, sem pixelização.",
			"preco": 0, "cor": Color("ff62df"), "raridade": "RASTRO • EXCLUSIVO",
			"stats": [0, 0, 0], "conquista": &"combo_213_spectrum",
			"contexto": "Recompensa inseparável do Spectrum, inspirada em rastros de arco-íris, mas redesenhada no neon do jogo.",
			"caminho": "", "icone": "res://UI/rastro_spectrum.svg", "em_breve": false,
			"grupo_personalizacao": &"rastro", "requer_modelo": &"c08_modelo_spectrum",
			"preservar_cores": true,
		},
		{
			"id": &"c23_rastro_fspeed", "nome": "MARCAS FSPEED",
			"descricao": "Duas marcas intermitentes de pneu acompanham as curvas e a cor da nave.",
			"preco": 0, "cor": Color("72f4ff"), "raridade": "RASTRO • EXCLUSIVO",
			"stats": [0, 0, 0], "conquista": &"pontos_75000000_fspeed",
			"contexto": "Rastro exclusivo do Fspeed, com marcas suaves de corrida em vez de partículas genéricas.",
			"caminho": "", "icone": "res://UI/rastro_fspeed.svg", "em_breve": false,
			"grupo_personalizacao": &"rastro", "requer_modelo": &"c09_modelo_fspeed",
		},
	]
