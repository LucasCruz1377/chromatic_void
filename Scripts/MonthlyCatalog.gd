...
static func personalizacao() -> Array[Dictionary]:
	return [
		...
		},
		{
			...
			"preco": 0, "cor": Color("57eaff"), "raridade": "MODELO • CROMÁTICO",
			"stats": [3, 3, 3], "conquista": &"combo_300_spectrum",
		...
		},
		{
			...
			"stats": [0, 0, 0], "conquista": &"combo_300_spectrum",
		...
		},
		{
			...
			"stats": [0, 0, 0], "conquista": &"pontos_38000000_fspeed",
