	...
	match str(dados.get("tipo", "")):
		"tecla":
			...
			if bool(dados.get("fisica", true)):
				tecla.physical_keycode = codigo as Key
			else:
				tecla.keycode = codigo as Key
